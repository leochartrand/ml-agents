...
from .ac_optimizer import ACSettings, ACOptimizer

logger = get_logger(__name__)

TRAINER_NAME = "ac"

class ACTrainer(OnPolicyTrainer):
    def __init__(
        self,
        behavior_name: str,
        reward_buff_cap: int,
        ...
        self.hyperparameters: ACSettings = cast(
            ACSettings, self.trainer_settings.hyperparameters
        )
        self.shared_critic = self.hyperparameters.shared_critic
        self.policy: TorchPolicy = None  # type: ignore

    # MAB: Same function as in A2CTrainer
    ...
    def create_optimizer(self) -> TorchOptimizer:
        ...
        """
        return ACOptimizer(  # type: ignore
...
def get_type_and_setting():
    return {ACTrainer.get_trainer_name(): ACTrainer}, {ACTrainer.get_trainer_name(): ACSettings}